...
packages="ags-hyprpanel-git apple_cursor base bat blueman brave-bin brightnessctl btop chili-sddm-theme clang cliphist cmake 
  ...
  git-delta glow gnome-keyring gnome-system-monitor google-chrome grim gtk3 gvfs gvfs-mtp htop hyprland hyprlock hyprpaper 
  ...
  p7zip pass perl-image-exiftool picom polybar poppler postman power-profiles-daemon pyenv python-gobject python-pipenv 
  python-pipx python-pynvim qt6ct ripgrep rofi seahorse shotwell stow teams-for-linux-bin thunar thunar-volman timidity++
