return {
	...
	config = function()
		...
		set({ "n", "v" }, "<M-J>", mc.nextCursor, { desc = "Select the cursor after the main cursor" })
		set({ "n", "v" }, "<M-K>", mc.prevCursor, { desc = "Select the cursor before the main cursor" })
		set({ "n", "v" }, "<M-g>", mc.firstCursor, { desc = "Select the first cursor" })
		set({ "n", "v" }, "<M-G>", mc.lastCursor, { desc = "Select the last cursor" })
